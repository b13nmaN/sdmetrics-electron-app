...
public class XMLParser {
	 ...
	 * 
	 * @throws ParserConfigurationException Problem with the JVM's XML parser
	 *         configuration.
	 * @throws SAXException The SAX parser could not be initialized.
	 */
	...
	public void parse(String uri, ContentHandler dh) throws Exception {
		...
		try {
			...
			errorMessage = "Parse error in line " + spe.getLineNumber() + ": " + spe.getMessage();
			ex = spe;
